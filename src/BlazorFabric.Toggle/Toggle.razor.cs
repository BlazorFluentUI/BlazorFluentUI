...
namespace BlazorFabric
{
    public partial class Toggle : FabricComponentBase
    {
        ...
        private void CreateCss()
        {
            ...
            ToggleRules.Add(new Rule() { Selector = new CssStringSelector() { SelectorName = ".ms-Toggle-stateText" }, Properties = new CssString() { Css = $"padding:0;margin:0 8px;user-select:none;font-weight:{Theme.FontStyle.FontWeight.Regular};" } });
            ToggleRules.Add(new Rule() { Selector = new CssStringSelector() { SelectorName = ".ms-Toggle--disabled .ms-Toggle-stateText" }, Properties = new CssString() { Css = $"color:{Theme.SemanticTextColors.DisabledText};" } });
