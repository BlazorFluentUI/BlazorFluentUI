...
{
    public partial class BFUGroupedListAuto<TItem> : BFUComponentBase, IDisposable
    {
        ...
        private void CreateSourceCache()
        {
            ...
            var published = sourceList.Connect()
            ...
            published.Bind(out groupedUIListItems)
                .Do(_ => {
