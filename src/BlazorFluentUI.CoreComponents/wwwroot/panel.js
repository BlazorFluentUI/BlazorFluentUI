...
Handler.i = 1;
Handler.listeners = {};
export function registerSizeHandler(panel) {
...
export function registerMouseDownHandler(panelElement, panelDotNet) {
...
export function makeElementScrollAllower(element) {
