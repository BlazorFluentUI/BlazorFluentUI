...
2. The Blazor team has been inconsistent with how static files from component libraries are added to projects lately.  You'll probably need to add all javascript and CSS assets from the component packages manually.  
