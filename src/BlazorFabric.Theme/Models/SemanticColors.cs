...
{
    public class SemanticColors: ISemanticColors
    {
        public string BodyBackground { get; set; }
        public string BodyBackgroundHovered {get; set;}
        public string BodyBackgroundChecked {get; set;}
        public string BodyStandoutBackground {get; set;}
        ...
        public string VariantBorder {get; set;}
        public string VariantBorderHovered {get; set;}
        public string DefaultStateBackground {get; set;}
        ...
        public string InputPlaceholderBackgroundChecked {get; set;}
        public string InputForegroundChecked {get; set;}
        public string InputFocusBorderAlt {get; set;}
        public string InputIconDisabled {get; set;}
        public string InputIcon {get; set;}
        public string InputIconHovered {get; set;}
        ...
        public string ButtonBackgroundDisabled {get; set;}
        public string ButtonBackgroundPressed {get; set;}
        public string ButtonBorder {get; set;}
        public string ButtonBorderDisabled {get; set;}
        public string PrimaryButtonBackground {get; set;}
        public string PrimaryButtonBackgroundHovered {get; set;}
        public string PrimaryButtonBackgroundPressed {get; set;}
        public string PrimaryButtonBackgroundDisabled {get; set;}
        public string PrimaryButtonBorder {get; set;}
        public string AccentButtonBackground {get; set;}
        ...
        public string MenuItemBackgroundPressed {get; set;}
