...
<Demo Header="Uncontrolled Multi-Selection" Key="1" MetadataPath="DropdownPage">
    <BlazorFluentUI.Label>Selected: @string.Join(", ", uncontrolledMultiSelectionResult.Select(x=>x.Text))</BlazorFluentUI.Label>
    <Dropdown ItemsSource=@items
                 MultiSelect="true"
...
<Demo Header="Controlled Single Selection" Key="2" MetadataPath="DropdownPage">
    <BlazorFluentUI.Label>Selected: @(controlledSingleSelectionResult?.Text)</BlazorFluentUI.Label>
    <Dropdown ItemsSource=@items 
                 Placeholder="Select an option" 
