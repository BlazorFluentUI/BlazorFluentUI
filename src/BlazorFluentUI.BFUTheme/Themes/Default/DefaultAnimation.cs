...
namespace BlazorFluentUI.Themes.Default
{
    ...
    {
        public string Duration1 => "0.167s";

        public string Duration2 => "0.267s";

        public string Duration3 => "0.367s";

        public string Duration4 => "0.467s";

        public string EasingFunction1 => "cubic-bezier(0.1,0.9,0.2,1)";
