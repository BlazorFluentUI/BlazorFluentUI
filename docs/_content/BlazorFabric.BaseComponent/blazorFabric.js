...
(function (BlazorFabricFocusTrapZone) {
    ...
    BlazorFabricFocusTrapZone.register = register;
    ...
    BlazorFabricFocusTrapZone.unregister = unregister;
    ...
    BlazorFabricFocusTrapZone.updateProps = updateProps;
    function focus(id) {
        var focusTrapZone = focusTrapZones[id];
        if (focusTrapZone) {
            focusTrapZone.focus();
...
(function (BlazorFabricFocusZone) {
    ...
    BlazorFabricFocusZone.register = register;
    function unregister(id) {
    ...
    BlazorFabricFocusZone.unregister = unregister;
    ...
    BlazorFabricFocusZone.updateFocusZone = updateFocusZone;
    var FocusZoneInternal = /** @class */ (function () {
        function FocusZoneInternal(focusZoneProps, dotNetRef) {
            ...
            this._onKeyDown = function (ev) {
                ...
                if (innerZoneKeystrokeTriggers && (innerZoneKeystrokeTriggers.indexOf(ev.keyCode) != -1) && _this._isImmediateDescendantOfZone(ev.target)) {
                    ...
                    else if (window.BlazorFabricBaseComponent.isElementFocusSubZone(ev.target)) {
                        if (!_this.focusElement(window.BlazorFabricBaseComponent.getNextElement(ev.target, ev.target.firstChild, true))) {
                            return;
                        }
                    }
                    else {
                    ...
                    switch (ev.which) {
                        ...
                        case 9 /* tab */:
                            if (_this._focusZoneProps.handleTabKey === FocusZoneTabbableElements.all ||
                                ...
                                if (direction === FocusZoneDirection.vertical ||
                                    ...
                                    var tabWithDirection = window.BlazorFabricBaseComponent.getRTL() ? !ev.shiftKey : ev.shiftKey;
                        ...
                        case 36 /* home */:
                            ...
                            if (_this._root && firstChild && _this.focusElement(window.BlazorFabricBaseComponent.getNextElement(_this._root, firstChild, true))) {
                                break;
                            }
                            return;
                        case 35 /* end */:
                            ...
                            if (_this._root && _this.focusElement(window.BlazorFabricBaseComponent.getPreviousElement(_this._root, lastChild, true, true, true))) {
                                break;
                            }
                            return;
                        case 13 /* enter */:
            ...
            this._onFocus = function (ev) {
                ...
                if (isImmediateDescendant) {
                    ...
                    while (parentElement && parentElement !== _this._root) {
                        if (window.BlazorFabricBaseComponent.isElementTabbable(parentElement) && _this._isImmediateDescendantOfZone(parentElement)) {
            ...
            this._onMouseDown = function (ev) {
                ...
                while (target && target !== _this._root) {
                    path.push(target);
                    target = window.BlazorFabricBaseComponent.getParent(target, ALLOW_VIRTUAL_ELEMENTS);
                }
                while (path.length) {
                    target = path.pop();
        ...
        FocusZoneInternal.prototype.updateFocusZone = function (props) {
            ...
            if (this._root) {
                var windowElement = window.BlazorFabricBaseComponent.getWindow(this._root);
                var parentElement = window.BlazorFabricBaseComponent.getParent(this._root, ALLOW_VIRTUAL_ELEMENTS);
       ...
       */
        ...
        FocusZoneInternal.prototype.focus = function (forceIntoFirstElement) {
            ...
            if (this._root) {
                if (!forceIntoFirstElement && this._root.getAttribute(IS_FOCUSABLE_ATTRIBUTE) === 'true' && this._isInnerZone) {
                    ...
                    return this.focusElement(window.BlazorFabricBaseComponent.getNextElement(this._root, firstChild, true));
                }
            }
            return false;
        };
        ...
        FocusZoneInternal.prototype._getOwnerZone = function (element) {
            var parentElement = window.BlazorFabricBaseComponent.getParent(element, ALLOW_VIRTUAL_ELEMENTS);
       ...
       */
        ...
        */
        ...
        FocusZoneInternal.prototype._moveFocus = function (isForward, getDistanceFromCenter, ev, useDefaultWrap) {
            ...
            do {
                element = (isForward ? window.BlazorFabricBaseComponent.getNextElement(this._root, element) : window.BlazorFabricBaseComponent.getPreviousElement(this._root, element));
                if (isBidirectional) {
                    if (element) {
            ...
            if (candidateElement && candidateElement !== this._activeElement) {
                ...
                if (isForward) {
                    return this.focusElement(window.BlazorFabricBaseComponent.getNextElement(this._root, this._root.firstElementChild, true));
                }
                else {
                    return this.focusElement(window.BlazorFabricBaseComponent.getPreviousElement(this._root, this._root.lastElementChild, true, true, true));
                }
            }
            return changedFocus;
        };
        ...
        FocusZoneInternal.prototype._moveFocusLeft = function () {
            ...
            if (this._moveFocus(window.BlazorFabricBaseComponent.getRTL(), function (activeRect, targetRect) {
                var distance = -1;
...
(function (BlazorFabricPanel) {
    ...
    BlazorFabricPanel.registerMouseDownHandler = registerMouseDownHandler;
    ...
    BlazorFabricPanel.makeElementScrollAllower = makeElementScrollAllower;
    function findScrollableParent(startingElement) {
        var el = startingElement;
        // First do a quick scan for the scrollable attribute.
        while (el && el !== document.body) {
...
})(BlazorFabricPanel || (BlazorFabricPanel = {}));
window['BlazorFabricPanel'] = BlazorFabricPanel || {};
